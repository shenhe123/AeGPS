package com.linkface.baselibrary.http;
...
import com.linkface.baselibrary.BuildConfig;
...
public class RetrofitClient {
    ...
    private RetrofitClient(Context context, String url, Map<String, String> headers) {
        ...
        headers.put("Authorization", SharedPrefUtils.getString("token_login"));
...
//                .addNetworkInterceptor(new CaheInterceptor(context))
    ...
    private HttpLoggingInterceptor loggingInterceptor = new HttpLoggingInterceptor(new HttpLoggingInterceptor.Logger() {
        ...
        public void log(String message) {
            //打印retrofit日志
            Log.i("shenhe_yuqinglog","retrofitBack = " + message);
        }
    });
