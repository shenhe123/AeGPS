...
public class DateUtil {
    ...
    public static String YEAR_MOUTH_DAY_MIN_SEC = "yyyy年MM月dd日 HH:mm";
    ...
    public static String TimeL2S(long time) {
        if (time > 0l) {
            SimpleDateFormat sdf = new SimpleDateFormat(YEAR_MOUTH_DAY_MIN_SEC);
    ...
    public static String changeFormatDate(String startDate, String format, String format2) {
        String str2= "";
        SimpleDateFormat sdf = new SimpleDateFormat(format);
...
//		System.out.println("相差的月数:" + leftMonth + ",相差的天数:" + leftDay);
    ...
    public static String formatDateTime(String dateTime) {
        ...
        if(!TextUtils.isEmpty(dateTime)){
            ...
            Date date = DateUtil.strToDate(dateTime, DateUtil.TIME_FORMAT);
