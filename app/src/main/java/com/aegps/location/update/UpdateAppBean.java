...
public class UpdateAppBean implements Serializable {
    ...
    public boolean isUpdate() {
        return !TextUtils.isEmpty(this.update) && "Y".equals(this.update);
    }
    ...
    public void setUseMd5Check(boolean useMd5Check) {
        this.useMd5Check = useMd5Check;
    }
    ...
    public void setShowToast(boolean mShowToast) {
