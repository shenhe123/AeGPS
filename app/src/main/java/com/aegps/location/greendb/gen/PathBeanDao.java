...
*/
public class PathBeanDao extends AbstractDao<PathBean, Void> {
    ...
    @Override
    protected final Void updateKeyAfterInsert(PathBean entity, long rowId) {
        // Unsupported or missing PK type
        return null;
    }
    
    @Override
    public Void getKey(PathBean entity) {
        return null;
    }
