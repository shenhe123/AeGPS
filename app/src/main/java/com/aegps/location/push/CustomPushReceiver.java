...
package com.aegps.location.push;
...
public class CustomPushReceiver extends XPushReceiver {
    ...
    private static final String KEY_PARAM_STRING = "key_param_string";
    private static final String KEY_PARAM_INT = "key_param_int";

    @Override
    public void onNotificationClick(Context context, XPushMsg msg) {
        super.onNotificationClick(context, msg);
        //打开自定义的Activity
        Intent intent = IntentUtils.getIntent(context, MainActivity.class, null, true);
